...
export const metadata: Metadata = { title: "Privacy Policy", description: "Techways privacy policy." };
...
const sections = [
  ...
  ["Your rights", "You can ask us to update or delete your personal data by emailing hello@techways.com."],
  ["Contact", "For privacy questions, contact hello@techways.com."],
];
